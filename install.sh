#!/usr/bin/env sh
# Universal installer for templates. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/templates.git"
